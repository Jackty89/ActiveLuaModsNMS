...
ProductPersonalInvetory                  = 5
ProductPersonalInvetoryCargo             = 10
...
Value_Change_Edits =
{
    ...
    ["RESTRICED"] =
    {
        ...
        ["VCT_EDITS_PROD"] =
        {
            {"Default",           ProductPersonalInvetory},
            {"Personal",          ProductPersonalInvetory},
            {"PersonalCargo",     ProductPersonalInvetoryCargo},
